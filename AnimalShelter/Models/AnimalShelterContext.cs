    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
      builder.Entity<Animal>()
        .HasData(
          ...
          new Animal { AnimalId = 7, Species = "Dog", Name = "Butter", Age = 3, Sex = "M", Description = "Will takes bites out of butter if left on the counter" },
          new Animal { AnimalId = 8, Species = "Cat", Name = "Oyster", Age = 2, Sex = "F", Description = "Loves to nap in dog beds" },
          new Animal { AnimalId = 9, Species = "Cat", Name = "Chad", Age = 2, Sex = "M", Description = "Just your basic golden retriever" }
        );
    }
